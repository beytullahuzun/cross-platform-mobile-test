...
public class InitializeTest {
  ...
  public static String platformSelection = "Android";  //Select either Android or Ios
  ...
  private AppiumDriver<MobileElement> initializeDriver() throws MalformedURLException {
    ...
    androidCaps.setCapability("appPackage", "com.appurl");
    androidCaps.setCapability("appActivity", "com.appurl.MainActivity");
    ...
    androidCaps2.setCapability("appPackage", "com.appurl");
    androidCaps2.setCapability("appActivity", "com.appurl.MainActivity");
    ...
    iosCaps.setCapability("app", "/Users/user1/Documents/sampleapp/sample2/sample2.app");
   ...
   */
    ...
    switch (platformSelection) {
      case "Android":
        driver = new AppiumDriver<>(new URL("http://127.0.0.1:4723/wd/hub"), androidCaps);
        break;
      case "Android2":
  ...
  private void loadElementIds() {
    try {
      switch (platformSelection) {
        case "Android":
          elementIds.load(getClass().getResourceAsStream("/Elements/androidIds.properties"));
          locatorTypes.load(getClass().getResourceAsStream("/Elements/locatorTypes.properties"));
        ...
        case "Android2":
          ...
          break;
        case "Ios":
          elementIds.load(getClass().getResourceAsStream("/Elements/iosIds.properties"));
          locatorTypes.load(getClass().getResourceAsStream("/Elements/locatorTypes.properties"));
